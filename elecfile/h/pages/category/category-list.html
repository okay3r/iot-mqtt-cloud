                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建" onclick='location.href="category-edit.jsp"'><i class="fa fa-file-o"></i> 新建</button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs" onclick='location.href="category-edit.jsp"'>编辑</button>
                                </td>
                            </tr>
                            <tr>
                                <td><input name="ids" type="checkbox"></td>
