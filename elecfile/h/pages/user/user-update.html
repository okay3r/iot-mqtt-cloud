                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" disabled="disabled" placeholder="创建时间"  name="createTime" class="form-control pull-right"
                                   value="${user.createTime}" id="datepicker">
                        </div>
                    </div>
                    <div class="col-md-2 title">上次登录时间</div>
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" disabled="disabled" placeholder="上次登录时间"  name="updateTime" class="form-control pull-right"
                                   value="${user.updateTime}" id="datepicker1">
                        </div>
                    </div>
